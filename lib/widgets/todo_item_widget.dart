    ...
    return Dismissible(
        ...
        return await showDialog<bool>(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: Text("Bạn có chắc muốn xóa công việc '${todo.title}' không?"),
              actions: <Widget>[
                TextButton(
      ...
      onDismissed: (direction) {
        ...
        ScaffoldMessenger.of(context)
          ...
          ..showSnackBar(
            SnackBar(content: Text('Đã xóa: ${todo.title}')),
          );
      },
      ...
      child: Card(
        ...
        child: Opacity(
          ...
          child: ListTile(
            ...
            onTap: () {
              if (isSelectionMode) {
                ...
                notifier.state = isSelected
                    ? (notifier.state..remove(todo.id))
                    : ({...notifier.state, todo.id});
              } else {
            ...
            onLongPress: () {
              if (!isSelectionMode) {
                ref.read(selectedTodosProvider.notifier).state = {todo.id};
              }
            },
            ...
            title: Text(
              ...
              style: TextStyle(
                ...
                color: todo.isCompleted ? Colors.grey[700] : null,
              ),
            ),
            ...
            trailing: Row(
              ...
              children: [
                Text(DateFormat('dd/MM').format(todo.date)),
                ...
                IconButton(
                  ...
                  onPressed: isSelectionMode ? null : () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (ctx) => AddEditTodoScreen.edit(
                          todo: todo,
                        ),
                      ),
                    );
